...
needs_types = [
    ...
    dict(directive="drs", title="Design Requirement", prefix="DRS_", color="#BFD8D2", style="node"),
    dict(directive="part", title="System element", prefix="PART_", color="#BFD8D2", style="node"),
    dict(directive="fmea", title="Failure mode", prefix="FMEA_", color="#DF744A", style="node"),
    dict(directive="test", title="Hardware Test Case", prefix="TC_", color="#DCB239", style="node"),
]
# needs_statuses = [
